...
note = ['# 아이디어별 수식과 참고문헌', '',
        ...
        '**현재 개선 범위:** 우선 검토인 보육·교육시설은 2040년까지의 0–17세 인구 시나리오에 따른 유지·증축·공간 전환·통합운영·통폐합·신설 대안, 후보인 돌봄·복지는 기존 시설 확충·운영·이동 연결 개선, 재난은 기존 도로·시설의 보강 효과 비교. 기후쉼터의 연속 시설밀도 2/3 식은 이론 비교용이며 신규 건설 계획이나 추가 정원의 배분 법칙이 아니다. 청소년의 0.6 ≤ α < 1은 사용자 지정 시나리오다.', '',
